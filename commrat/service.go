...
type CommRatService interface {
	CreateComment(ctx context.Context, text string, userID string, chargerID string) (string, error)
	...
	//
	CreateRating(ctx context.Context, rating float64, userID string, chargerID string) (string, error)
